            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark active" href="bantuan.php" aria-expanded="false"><i class="mdi mdi-help-circle"></i><span class="hide-menu">Bantuan</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                      <h3 class="text-themecolor m-b-0 m-t-0">Bantuan</h3>
                            ...
                            <div class="card-block">
                                ...
                                <ul>
                                  <ol>
                                    ...
                                    <li>Menu <code>Tulis Pesan</code> merupakan menu untuk mengirim pesan atau email.</li>
                                    <li>Menu <code>Kotak Masuk</code> merupakan menu untuk melihat pesan masuk dengan mengklik "Lihat Pesan" <br>kemudian masukan kunci kriptografi untuk mendekrip pesan beserta lampiran.</li>
                                    <li>Menu <code>Bantuan</code> merupakan menu untuk membantu user dalam penggunaan aplikasi.</li>
                                    <li>Menu <code>Tentang</code> merupakan menu informasi mengenai aplikasi SRK Mail.</li>
                                  </ol>
                                </ul>
                            </div>
                        </div>
