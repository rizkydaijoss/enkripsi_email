            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="tentang.php" aria-expanded="false"><i class="mdi mdi-information-variant"></i><span class="hide-menu">Tentang</span></a></li>
						<br>
						<br>
						<br>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
							...
							<center> <img src="assets/images/logo/srk.jpg" alt="" width="150px"></center>
                     
                                <h2 style="text-align:center">Aplikasi Keamanan Kriptografi Email PT. Sinar Rasa Kencana</h2>
