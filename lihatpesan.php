...
<head>
    ...
    <title><?php echo $msg_subject ?> - Lihat Pesan</title>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                      ...
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item">Lihat Pesan</a></li>
                            ...
                            <div class="card-block">
                              ...
                              if(isset($_POST['dekrippesan'])){
                                  ...
                                  <tr>
                                    ...
                                    <p><h4>&nbsp;&nbsp;Halaman ini selesai dieksekusi dalam waktu <?php echo $waktu ?> detik</p>
                                  </div>
                                  <?php
                                }
                            if (empty($_POST)) { ?>
                              <div class="container">
                                <form action="" method="POST" class="form-horizontal">
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-4">
                                        <input type="password" class="form-control" name="kunci" required placeholder="">
                                      </div>
                                    </div>
                                    <div class="form-group row">
